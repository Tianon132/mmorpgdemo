...
namespace GameServer.Managers
{
    public class DataManager : Singleton<DataManager>
    {
        ...
        internal Dictionary<int, TeleporterDefine> Teleporters = null;//传送点
        ...
        public Dictionary<int, NpcDefine> Npcs = null;//NPC
        public Dictionary<int, ItemDefine> Items = null;//道具
        public Dictionary<int, ShopDefine> Shops = null;
        public Dictionary<int, Dictionary<int, ShopItemDefine>> ShopItems = null;
        public Dictionary<int, EquipDefine> Equips = null; //装备
        public Dictionary<int, QuestDefine> Quests = null;//任务
